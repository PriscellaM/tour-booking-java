...
////		System.out.println(insurance(6,1));	//test
//		do {
//			printMenu();
...
//							double pickupCost=pickupCostforInter((adultPax+childPax), input);
//							tic.setPickup(pickup);
...
//							input.nextLine();
//							double insurance=tic.Insurance(uInput);
////							System.out.println(insurance);		//test
//							try {
//								tic.setInsurance(insurance);								
...
//	}
//	
//	public static double pickupCostforInter(int pax, Scanner in) {		//for pickupCost for Interstate/International tour
...
//		return pickupCost;
//	}
//	public static double insurance(int pax, int input) {
//		double insurance=0.0;
//		if(input!=1) { insurance=0.0; }
//		else {
//			while(pax>0) {
//				if(pax<=0) {break;}
